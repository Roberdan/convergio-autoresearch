...
[![CI](https://github.com/Roberdan/convergio-autoresearch/actions/workflows/ci.yml/badge.svg)](https://github.com/Roberdan/convergio-autoresearch/actions/workflows/ci.yml)
[![License: Convergio Community](https://img.shields.io/badge/license-Convergio%20Community-blue)](https://github.com/Roberdan/convergio-autoresearch/blob/main/LICENSE)
...
```mermaid
graph LR
    CRATE[convergio-autoresearch] --> SDK[convergio-sdk]
    SDK --> T[types]
    SDK --> TEL[telemetry]
    SDK --> DB[db]
    SDK --> SEC[security]
...
```toml
[dependencies]
convergio-autoresearch = { git = "https://github.com/Roberdan/convergio-autoresearch", tag = "v0.1.0" }
```
